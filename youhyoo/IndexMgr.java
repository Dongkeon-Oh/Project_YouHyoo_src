...
public class IndexMgr {
	...
	****/
	...
	//--------------------
	/*
	select * from room where r_pension=1 and r_num=(select o_rnum from order_room where o_date!='2016-05-30');  
	*/
	public List getDRList(int p_num, String o_date){
		Connection con=null;
		ResultSet rs=null;
		Statement stmt=null;
